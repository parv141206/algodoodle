...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav className=" sticky top-0 z-[100]  flex  flex-col justify-between gap-3 border-b bg-white p-3 dark:border-gray-700 dark:bg-gray-800/75 md:flex-row  md:bg-white/50 md:px-10   md:backdrop-blur-3xl ">
