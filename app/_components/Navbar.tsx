...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav className=" sticky top-0  z-10  flex flex-col justify-between gap-3  border-b bg-white/50 p-3 backdrop-blur-3xl  dark:border-gray-700 dark:bg-gray-800/75   md:flex-row ">
